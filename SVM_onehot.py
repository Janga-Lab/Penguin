...
df1 = pd.read_csv("Ps_Modification_coors_hek_complete.txt",sep=' ',skiprows=(0),header=(0))#Pseu_Modification_coors_ns_hek.txt
...
plt.tight_layout()
#plt.show()
plt.savefig('SVM_onehot_LC.png', dpi=300)
#plt.savefig('SVM_onehot_LC.svg')
plt.close() 
...
#plt.show() 
plt.savefig('SVM_onehot_ROC.png', dpi=300)
#plt.savefig('SVM_onehot_ROC.svg')
